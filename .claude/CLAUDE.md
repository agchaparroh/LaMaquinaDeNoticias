...
## PRP Mode - Product Requirements Prompt Integration
Context Engineering's PRP system is available as an optional mode for complex features.

### When to Use PRP Mode
@include commands/shared/prp-patterns.yml#Complexity_Triggers

### PRP Commands
- `/prp --init [description]` - Evaluate if feature needs PRP mode
- `/prp --generate [feature]` - Create comprehensive PRP with research
- `/prp --execute [prp-file]` - Implement with validation loops
- `/task:prp [task-id]` - Convert existing task to PRP format
...
Continue with standard SuperClaude commands for:
- Single file changes
- Simple bug fixes
...
### Integration
@include commands/shared/prp-patterns.yml#PRP_Task_Integration
