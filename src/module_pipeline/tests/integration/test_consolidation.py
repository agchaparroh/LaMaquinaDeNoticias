...
from ...src.config import get_processing_config, pipeline_config  # noqa: F401
    ...
    return [
        ...
        [
            ...
            },
            {
                ...
                "tipo": "ORGANIZACION",
                "descripcion": "Organismo gubernamental",
            },
        ],
        # Chunk 2
        [
            ...
            },  # Sin tilde, más descripción
            {
                "id": 4,
                "nombre": "María González",
                "tipo": "PERSONA",
                "descripcion": "Ministra",
            },
        ],
        # Chunk 3
        [
...
def hechos_similares():
    ...
    return [
        ...
        [
            {
                "id": 1,
                "contenido": "El presidente se reunió con el ministro de economía",
                "tipo_hecho": "EVENTO",
                "fecha": "2024-01-15",
            },
            {
                "id": 2,
                "contenido": "Se anunció un aumento del presupuesto",
                "tipo_hecho": "ANUNCIO",
                "fecha": "2024-01-15",
            },
        ],
        ...
        [
            {
                "id": 3,
                "contenido": "Reunión presidencial con ministro económico",
                "tipo_hecho": "EVENTO",
                "fecha": "2024-01-15",
            },  # Similar al ID 1
            {
                "id": 4,
                "contenido": "Nueva inversión en infraestructura",
                "tipo_hecho": "ANUNCIO",
                "fecha": "2024-01-15",
            },
        ],
        ...
        [
            {
                "id": 5,
                "contenido": "El mandatario y el titular de economía se encontraron",
                "tipo_hecho": "EVENTO",
                "fecha": "2024-01-15",
            },  # Similar al ID 1
            {
                "id": 6,
                "contenido": "Incremento presupuestario aprobado",
                "tipo_hecho": "ANUNCIO",
                "fecha": "2024-01-15",
            },  # Similar al ID 2
        ],
        ...
        [
            {
                ...
                "valor": "500 millones",
                "unidad": "pesos",
                "concepto": "inversión infraestructura",
                "contexto": "presupuesto adicional",
            },
            {
                "id": 2,
                "valor": "3.5",
                "unidad": "porcentaje",
                "concepto": "crecimiento PIB",
                "contexto": "este trimestre",
            },
        ],
        # Chunk 2
        [
            {
                ...
                "valor": "500000000",
                "unidad": "pesos",
                "concepto": "inversión en infraestructura",
                "contexto": "presupuesto extra",
            },  # Mismo valor, diferente formato
            {
                "id": 4,
                "valor": "2500",
                "unidad": "empleos",
                "concepto": "empleos directos",
                "contexto": "generados por inversión",
            },
        ],
        # Chunk 3
        [
            {
                ...
                "unidad": "",
                "concepto": "PIB",
                "contexto": "crecimiento trimestral",
            },  # Similar al ID 2
            {
                "id": 6,
                "valor": "4.2",
...
def citas_textuales_similares():
    ...
    return [
        ...
        [
            {
                "id": 1,
                "texto": "Estamos comprometidos con el crecimiento",
                "autor": "Juan Pérez",
                "contexto": "rueda de prensa",
            },
            {
                "id": 2,
                "texto": "Esta medida estimulará la inversión privada",
        ...
        [
            {
                "id": 3,
                "texto": "Estamos comprometidos con el crecimiento económico",
                "autor": "Juan Perez",
                "contexto": "conferencia",
            },  # Similar pero más específica
            {
                "id": 4,
                "texto": "Queremos que las PyMEs sean el motor",
                "autor": "Roberto Silva",
                "contexto": "anuncio",
            },
        ],
        ...
        [
            {
                ...
                "texto": '"Estamos comprometidos con el crecimiento"',
                "autor": "Presidente",
                "contexto": "declaraciones",
            },  # Con comillas y autor genérico
            {
                "id": 6,
                "texto": "La medida estimulará inversión",
                "autor": "González",
                "contexto": "rueda de prensa",
            },  # Parafraseo del ID 2
        ],
...
class TestEntityConsolidation:
    ...
    def test_consolidate_similar_entities_with_threshold(
        self, consolidation_service, entidades_duplicadas
    ):
        ...
        assert len(resultado) == 3, (
            "Deberían quedar 3 entidades: Juan Pérez consolidado, Ministerio consolidado, María González"
        )
        ...
        assert len(juan_perez["descripcion"]) > 0, (
            "Debería preservar la descripción más completa"
        )
            ...
            [
                {
                    ...
                    "nombre": "Juan Pérez",
                    "tipo": "PERSONA",
                    "descripcion": "Presidente de la República Argentina",
                }
            ],
        ]
    ...
    def test_different_entity_types_not_consolidated(self, consolidation_service):
        ...
        entidades_diferentes = [
            ...
            [
                {"id": 2, "nombre": "Banco Nacional", "tipo": "LUGAR"}
            ],  # Mismo nombre, diferente tipo
        ]

        resultado = consolidation_service.consolidate_entities(entidades_diferentes)

        assert len(resultado) == 2, (
            "Entidades de diferentes tipos no deberían consolidarse"
        )
...
class TestFactConsolidation:
    ...
    def test_consolidate_similar_facts(self, consolidation_service, hechos_similares):
        ...
        assert any(
            "reunión" in c.lower() or "encontraron" in c.lower() for c in contenidos
        )
    ...
    def test_facts_with_same_content_consolidated(self, consolidation_service):
        ...
        hechos_identicos = [
            [
                {
                    "id": 1,
                    "contenido": "Se anunció una nueva medida económica",
                    "tipo_hecho": "ANUNCIO",
                }
            ],
            [
    ...
    def test_facts_different_dates_not_consolidated(self, consolidation_service):
        ...
        hechos_fechas_diferentes = [
            [
                {
                    "id": 1,
                    "contenido": "Reunión presidencial",
                    "tipo_hecho": "EVENTO",
                    "fecha": "2024-01-15",
                }
            ],
        ...
        assert len(resultado) == 2, (
            "Hechos con fechas diferentes no deberían consolidarse"
        )
    ...
    def test_fact_consolidation_preserves_context(self, consolidation_service):
        ...
        hechos_con_contexto = [
            [
                {
                    "id": 1,
                    "contenido": "Anuncio económico",
                    "tipo_hecho": "ANUNCIO",
                    "ubicacion": "Casa de Gobierno",
                }
            ],
            [
                {
                    "id": 2,
                    "contenido": "Anuncio sobre economía",
                    "tipo_hecho": "ANUNCIO",
                    "participantes": ["Presidente", "Ministro"],
                }
            ],
        ]
...
class TestQuantitativeDataConsolidation:
    ...
    def test_consolidate_same_values_different_formats(
        self, consolidation_service, datos_cuantitativos_duplicados
    ):
        """Test consolidación de valores iguales en diferentes formatos."""
        resultado = consolidation_service.consolidate_quantitative_data(
            datos_cuantitativos_duplicados
        )
        ...
        valores_inversion = [
            d
            for d in resultado
            if "inversión" in d["concepto"].lower()
            or "infraestructura" in d["concepto"].lower()
        ]
        assert len(valores_inversion) == 1, (
            "Valores de inversión en diferentes formatos deberían consolidarse"
        )
    ...
    def test_numerical_normalization(self, consolidation_service):
        ...
        assert (
            consolidation_service._normalize_numerical_value("500 millones")
            == 500000000
        )
...
class TestQuoteConsolidation:
    ...
    def test_consolidate_similar_quotes(
        self, consolidation_service, citas_textuales_similares
    ):
        ...
        citas_crecimiento = [
            c for c in resultado if "crecimiento" in c["texto"].lower()
        ]
        assert len(citas_crecimiento) == 1, (
            "Citas similares sobre crecimiento deberían consolidarse"
        )
    ...
    def test_quotes_different_authors_not_consolidated(self, consolidation_service):
        ...
        assert len(resultado) == 2, (
            "Citas del mismo texto pero diferentes autores no deberían consolidarse"
        )
    ...
    def test_quote_context_preservation(self, consolidation_service):
        ...
        citas_con_contexto = [
            ...
            [
                {
                    "id": 2,
                    "texto": "Medida muy importante",
                    "autor": "Presidente",
                    "contexto": "conferencia magistral",
                    "fecha": "2024-01-15",
                }
            ],
        ]
...
class TestSimilarityAlgorithms:
    ...
    def test_semantic_similarity_integration(self):
        ...
        if callable(calculate_semantic_similarity):
            text1 = "presidente"
            text2 = "mandatario"
            text3 = "computadora"
...
class TestConsolidationConfiguration:
    ...
    def test_similarity_threshold_configuration(self, consolidation_service):
        ...
        config = get_processing_config()  # noqa: F841
    ...
    def test_threshold_affects_consolidation_behavior(self, consolidation_service):
        ...
        resultado_permisivo = consolidation_service.consolidate_entities(
            entidades_moderamente_similares
        )

        # Con threshold alto (estricto)
        consolidation_service.similarity_threshold = 0.95
        resultado_estricto = consolidation_service.consolidate_entities(
            entidades_moderamente_similares
        )
...
class TestConsolidationPerformance:
    ...
    def test_consolidation_with_large_datasets(self, consolidation_service):
        ...
        assert processing_time < 5.0, (
            f"Consolidación demasiado lenta: {processing_time:.2f}s"
        )
    ...
    def test_memory_usage_during_consolidation(self, consolidation_service):
        ...
        try:
            resultado = consolidation_service.consolidate_entities(
                memory_intensive_data
            )
