...
from ...src.models.persistencia import (
    ArticuloPersistenciaPayload,  # noqa: F401
    ContradiccionDetectadaItem,  # noqa: F401
    EntidadAutonomaItem,  # noqa: F401
    HechoExtraidoItem,  # noqa: F401
    RelacionEntidadesItem,  # noqa: F401
    RelacionHechosItem,  # noqa: F401
)
...
class TestRelacionesPayload(unittest.TestCase):
    ...
    def test_contradicciones_mapeo_correcto(self):
        ...
        self.assertEqual(
            contradiccion.descripcion, "Los hechos presentan información contradictoria"
        )
