"""
Test rápido para verificar el sistema de manejo de errores
==========================================================

Este script ejecuta pruebas básicas para verificar que el sistema
de manejo de errores está funcionando correctamente.
"""
...
def test_custom_exceptions():
    ...
    try:
        ...
        exc = ValidationError(
            ...
            validation_errors=["titulo es requerido", "contenido muy corto"],
...
def test_error_responses():
    ...
    try:
        # Test respuesta de validación
        exc = ValidationError(
            message="Datos inválidos",
            validation_errors=["El título es muy corto"],
            phase=ErrorPhase.GENERAL
        )
        ...
        print(f"   - Detalles: {content['detalles']}")
...
def test_logging_format():
    ...
    try:
        ...
        print(f"   - Fase: {log_data['fase']}")
        print(f"   - Tipo error: {log_data['error_type']}")
        print(f"   - Artículo ID: {log_data.get('articulo_id', 'N/A')}")
        print(f"   - Context extra: {log_data['context']}")
...
def main():
    ...
    print("=" * 60)
    print("VERIFICACIÓN RÁPIDA DEL SISTEMA DE MANEJO DE ERRORES")
    print("=" * 60)
