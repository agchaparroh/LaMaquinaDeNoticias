...
class BatchMigrator:
    ...
    def migrate_directory(self, directory: Path, dry_run: bool = False) -> Dict[str, List]:
        """
        ...
        for spider_file in spider_files:
            ...
            if not validation['valid']:
                ...
                self.results['skipped'].append({
                    'file': spider_file.name,
                    'reason': 'Ya migrado/válido'
                })
    ...
    def _migrate_single_spider(self, spider_path: Path, validation: Dict, 
...
def main():
    ...
    parser.add_argument('--generate-script', action='store_true', help='Genera script de migración')
    parser.add_argument('--script-output', type=Path, default=Path('migrate_all.sh'), help='Archivo de salida del script')
