...
class PerformanceMetrics:
    ...
    async def validate_generation_time(
        self, strategy: str, tiempo: float
    ) -> Tuple[bool, str]:
        """
    ...
    async def _record_performance_validation(
        self, strategy: str, tiempo: float, meets_target: bool
    ):
        """
    ...
    async def analyze_performance_trends(self) -> Dict[str, Any]:  # noqa: F821
        """
        ...
        for strategy in ["rss", "scraping", "playwright", "cache"]:
            ...
            trends[strategy] = {
                ...
                "trend": trend,
                "kpi_compliance": round(
                    await self.get_kpi_compliance_rate(strategy), 2
                ),
            }

        return trends

    async def get_bottleneck_analysis(self) -> Dict[str, Any]:  # noqa: F821
        """
        ...
        for strategy, data in trends.items():
            ...
            if strategy == "rss" and data["average"] > PerformanceTarget.RSS_TIME.value:
                ...
                strategy == "cache"
                and data["average"] > PerformanceTarget.CACHE_TIME.value
            ):
                bottlenecks.append(
                    {
                ...
                strategy in ["scraping", "playwright"]
                and data["average"] > PerformanceTarget.FIRST_TIME.value * 1.5
            ):
                bottlenecks.append(
                    {
            ...
            "projections": {
                ...
                "yearly": {
                    ...
                    "fte_equivalent": round(
                        (yearly_time_saved / 60) / 2080, 2
                    ),  # 2080 = horas laborales/año
                },
            },
            "meets_target": reduction_percentage
            >= PerformanceTarget.MIN_REDUCTION.value,
        }
...
"""  # noqa: F541
        ...
        report += f"\n\n🚨 ANÁLISIS DE CUELLOS DE BOTELLA:"  # noqa: F541
        ...
        if "error" not in savings:
            ...
            report += f"\n\nProyecciones de ahorro:"  # noqa: F541
...
async def track_performance(
    ...
    meets_kpi, message = await performance_metrics.validate_generation_time(
        strategy, duration
    )
