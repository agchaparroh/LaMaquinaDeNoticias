...
class SpiderGenerator:
    ...
    def __init__(self, templates_dir: Optional[str] = None):
        ...
        logger.info(
            f"SpiderGenerator inicializado con templates en: {self.templates_dir}"
        )
    ...
    def _build_template_context(
        ...
        context = {
            ...
            # Helpers
            "has_selector": lambda x: x in analysis.selectors.__dict__
            and getattr(analysis.selectors, x),
        ...
        protection_level = (
            ...
            if hasattr(analysis, "protection_level")
            else "basic"
        )
        if protection_level != "basic":
            ...
            logger.info(
                f"Applied evasion config for {protection_level} protection level"
            )
    ...
    def preview_spider(
        ...
        full_code = self.generate_spider(
            analysis, medio, seccion, area_geografica, tipo_medio, frecuencia_minutos
        )
...
def test_generator():
    ...
    spider_code = generator.generate_spider(
        ...
        additional_config={"excluded_urls": ["*/tags/*", "*/author/*"]},
    )
