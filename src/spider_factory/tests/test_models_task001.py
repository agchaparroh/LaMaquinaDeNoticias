...
sys.path.insert(
    0,
    "/mnt/c/Users/DELL/Desktop/PruebaWindsurfAI/LaMaquinaDeNoticias/src/spider_factory",
)
...
sys.modules["src.analyzer"].AnalysisStrategy = type(
    "AnalysisStrategy", (), {"RSS": "rss", "STATIC": "static"}
)
...
def test_duplicate_check_request():
    ...
    # Test válido
    try:
        req = models.DuplicateCheckRequest(medio="El País", seccion="Política")
        print(f"✓ Creación exitosa")  # noqa: F541
...
def test_generate_spider_request():
    ...
    try:
        req = models.GenerateSpiderRequest(analysis_url="https://example.com")
        print("✗ No debería permitir crear sin campos obligatorios")
        return False
    except ValidationError as e:  # noqa: F841
        print("✓ Validación correcta: rechaza request sin campos obligatorios")
