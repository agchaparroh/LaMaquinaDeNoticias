...
def main():
    ...
    commands = [
        ...
        (
            ...
            "Listando todos los tests disponibles",
        ),
        # 3. Ejecutar tests unitarios
        (
            "python -m pytest tests/unit/test_models.py -v",
            "Ejecutando tests del modelo ArticuloInItem",
        ),
    ...
    # Resumen final
    print(f"\n{'=' * 60}")
    print(f"📊 RESUMEN DE EJECUCIÓN")  # noqa: F541
    print(f"{'=' * 60}")
    ...
    print(f"\n📚 INFORMACIÓN ADICIONAL:")  # noqa: F541
    print(f"- Para ejecutar todos los tests: python -m pytest tests/ -v")  # noqa: F541
    print(
        f"- Para ver cobertura completa: python -m pytest tests/ --cov=src --cov-report=html"
    )  # noqa: F541
    print(f"- Para tests en paralelo: python -m pytest tests/ -n auto")  # noqa: F541
    print(f"- Documentación completa en: tests/README.md")  # noqa: F541
