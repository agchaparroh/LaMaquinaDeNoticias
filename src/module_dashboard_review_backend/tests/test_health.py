...
from src.main import START_TIME, app
...
class TestHealthEndpoints:
    ...
    def test_detailed_health_endpoint_success(
        self, mock_execute_retry, mock_get_client
    ):
    ...
    @patch("src.services.supabase_client.SupabaseClient.get_client")
    @patch("src.services.supabase_client.SupabaseClient.execute_with_retry")
    def test_detailed_health_endpoint_degraded(
        self, mock_execute_retry, mock_get_client
    ):
...
class TestHealthCheckFunction:
    ...
    @patch("src.services.supabase_client.SupabaseClient.get_client")
    @patch("src.services.supabase_client.SupabaseClient.execute_with_retry")
    async def test_check_supabase_health_success(
        self, mock_execute_retry, mock_get_client
    ):
    ...
    @patch("src.services.supabase_client.SupabaseClient.get_client")
    @patch("src.services.supabase_client.SupabaseClient.execute_with_retry")
    async def test_check_supabase_health_error(
        self, mock_execute_retry, mock_get_client
    ):
