...
from src.models.requests import HechoFilterParams, PaginationParams
...
class TestTipoRelacion:
    ...
    def test_tipos_relacion_values(self):
        ...
        expected_values = {
            "consecuencia", "causa", "contradictorio", "complementario",
            "temporal_anterior", "temporal_posterior", "misma_fuente",
            "actualizacion", "correccion", "ampliacion"
        }
...
class TestArticuloMetadata:
    ...
    def test_campos_opcionales(self, valid_articulo_data):
        ...
        optional_fields = ["url", "autor", "seccion", "resumen", "puntuacion_relevancia"]
