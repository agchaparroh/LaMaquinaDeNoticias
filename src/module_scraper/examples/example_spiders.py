...
from scraper_core.spiders.base import (
    BaseArticleSpider,
    BaseCrawlSpider,
    BaseSitemapSpider,
)
...
class ExampleSitemapSpider(BaseSitemapSpider):
    ...
    def parse_politics_article(self, response: Response):
        ...
        article_data["political_parties"] = response.css(
            ".political-party-tag::text"
        ).getall()
...
class ExampleCrawlSpider(BaseCrawlSpider):
    ...
    def parse_article(self, response: Response):
        ...
        article_data["discovered_from"] = response.request.headers.get(
            "Referer", b""
        ).decode("utf-8")
