...
class ExampleSpider(Spider):
    ...
    def parse(self, response):
        ...
        for article in articles:
            ...
            loader.add_css(
                "etiquetas_fuente", "span.tag::text"
            )  # Procesará múltiples tags
            ...
            if article_url:
                ...
                yield response.follow(
                    article_url, callback=self.parse_article, meta={"loader": loader}
                )
...
def example_xpath_usage(response):
    ...
    loader.add_xpath(
        "fecha_publicacion", '//meta[@property="article:published_time"]/@content'
    )
...
def example_custom_processing():
    ...
    """
    from itemloaders.processors import MapCompose  # noqa: F401
