...
def process_item_through_pipelines(
...
def main():
    ...
    print(f"{'=' * 60}")
    print(f"\nValidation Pipeline Stats:")  # noqa: F541
    ...
    print(
        f"  - Error types: {validation_pipeline.validation_stats['validation_errors']}"
    )

    print(f"\nCleaning Pipeline Stats:")  # noqa: F541
        ...
        with open(output_file, "w", encoding="utf-8") as f:
            ...
            for item in successful_items:
                ...
                if "contenido_html" in item_dict:
                    item_dict["contenido_html"] = (
                        f"<HTML content: {len(item_dict['contenido_html'])} chars>"
                    )
