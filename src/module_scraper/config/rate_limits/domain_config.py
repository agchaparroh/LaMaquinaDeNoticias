...
DEFAULT_RATE_LIMIT = {"concurrency": 2, "delay": 2.0, "randomize_delay": True}

# Conservative configuration for high-traffic or sensitive sites
CONSERVATIVE_RATE_LIMIT = {"concurrency": 1, "delay": 5.0, "randomize_delay": True}

# Aggressive configuration for sites known to handle high traffic well
AGGRESSIVE_RATE_LIMIT = {"concurrency": 4, "delay": 1.0, "randomize_delay": True}

# Domain-specific rate limiting configurations
DOMAIN_RATE_LIMITS: Dict[str, Dict[str, Any]] = {
    # Major international news sites
    "cnn.com": {"concurrency": 1, "delay": 3.0, "randomize_delay": True},
    "bbc.com": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    "nytimes.com": {"concurrency": 1, "delay": 4.0, "randomize_delay": True},
    "theguardian.com": {"concurrency": 2, "delay": 2.0, "randomize_delay": True},
    "reuters.com": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    # Spanish news sites
    "elpais.com": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    "elmundo.es": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    "lavanguardia.com": {"concurrency": 2, "delay": 3.0, "randomize_delay": True},
    "abc.es": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    # Latin American news sites
    "clarin.com": {"concurrency": 2, "delay": 2.0, "randomize_delay": True},
    "lanacion.com.ar": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    "eluniversal.com.mx": {"concurrency": 2, "delay": 2.5, "randomize_delay": True},
    "eltiempo.com": {"concurrency": 2, "delay": 2.0, "randomize_delay": True},
    # Tech news sites (usually handle traffic better)
    "techcrunch.com": {"concurrency": 3, "delay": 1.5, "randomize_delay": True},
    "theverge.com": {"concurrency": 3, "delay": 1.5, "randomize_delay": True},
    "arstechnica.com": {"concurrency": 3, "delay": 1.5, "randomize_delay": True},
...
def apply_rate_limit_category(domain: str, category: str) -> None:
    ...
    if category in categories:
        ...
        raise ValueError(
            f"Unknown category: {category}. Use 'default', 'conservative', or 'aggressive'"
        )
