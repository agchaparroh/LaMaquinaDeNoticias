...
from scrapy import Spider  # noqa: F401
from scrapy.http import HtmlResponse, Request
from scrapy.utils.test import get_crawler  # noqa: F401
...
class TestBaseArticleSpider(unittest.TestCase):
    ...
    def test_validate_article_data_valid(self):
        ...
        article_data = {
            ...
            "content": "This is a valid article with enough content to pass validation. "
            * 10,
        }
    ...
    def test_base_spider_custom_settings(self):
        ...
        self.assertIn("USER_AGENT", settings, "custom_settings debe incluir USER_AGENT")
        self.assertIn(
            "ROBOTSTXT_OBEY", settings, "custom_settings debe incluir ROBOTSTXT_OBEY"
        )
        self.assertTrue(
            settings.get("ROBOTSTXT_OBEY", False),
    ...
    def test_base_spider_provides_error_callback(self):
        ...
        request = self.spider.make_request(
            "http://example.com/test", errback=self.spider.handle_error
        )
    ...
    def test_base_spider_compatible_with_crawl_once(self):
        ...
        request = self.spider.make_request(
            "http://example.com/article", meta={"crawl_once": True}
        )
