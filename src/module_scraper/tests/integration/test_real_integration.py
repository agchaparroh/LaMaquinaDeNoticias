...
class TestRealIntegration:
    ...
    def test_real_article_extraction(self):
        ...
        print(f"\n🌐 Test de Integración Real:")  # noqa: F541
    ...
    def test_pipeline_integration(self):
        ...
        print(f"\n🔄 Test de Pipeline Completo:")  # noqa: F541
        ...
        # Verificaciones
        assert final_item["titular"].strip() == final_item["titular"], (
            "Título no fue limpiado"
        )
        assert "<p>" not in final_item["contenido_texto"], "HTML no fue removido"
        assert "\n\n\n" not in final_item["contenido_texto"], (
            "Múltiples saltos no fueron normalizados"
        )
