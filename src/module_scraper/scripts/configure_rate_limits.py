...
from config.rate_limits.domain_config import (  # noqa: E402
    DOMAIN_RATE_LIMITS,
...
def main():
    ...
    update_parser.add_argument(
        "--concurrency", type=int, help="Max concurrent requests"
    )
    update_parser.add_argument(
        "--randomize", type=bool, help="Randomize delay (true/false)"
    )
