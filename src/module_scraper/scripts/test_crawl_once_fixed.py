...
VERSIÓN MODIFICADA: Desactiva pipelines para evitar error de Supabase.
"""
...
def run_spider(second_run=False):
    ...
    cmd = [
        ...
        "-s", "ITEM_PIPELINES={}",        # Deshabilitar pipelines para evitar error de Supabase
    ]
...
def main():
    ...
    """
    print("🕷️  TEST AUTOMATIZADO DE SCRAPY-CRAWL-ONCE (VERSIÓN FIJA)")
    print("=" * 60)
    ...
    print("NOTA: Pipelines desactivados para evitar error de Supabase.")
    print()
