...
Medio: La Gaceta de la Iberoesfera
Sección: iberosfera
Fecha: 2025-07-01T19:04:30.123456
Estrategia: rss
...
class LaGacetaDeLaIberosferaIberoseraSpider(scrapy.Spider):
    """
    Spider RSS para La Gaceta de la Iberoesfera - iberosfera

    Utiliza feeds RSS para obtener artículos de noticias.
    Área geográfica: HISPANIDAD
    Tipo de medio: diario
    """

    name = "la_gaceta_de_la_iberoesfera_iberosfera"
    allowed_domains = ["gaceta.es"]
    ...
    custom_settings = {
        ...
        "CRAWL_ONCE_PATH": f".scrapy/crawl_once/la_gaceta_de_la_iberoesfera_iberosfera",  # noqa: F541
        ...
        # Project: lamaquina
        # Spider: la_gaceta_de_la_iberoesfera_iberosfera
        # Arguments: -a max_items=20
    }

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.rss_url = "https://gaceta.es/iberosfera/feed/"
        ...
        self.medio_info = {
            "medio": "La Gaceta de la Iberoesfera",
            "seccion": "iberosfera",
            "area_geografica": "HISPANIDAD",
            "tipo_medio": "diario",
            "medio_url_principal": "https://gaceta.es/iberosfera/",
    ...
    def _process_rss_content(self, rss_content: str):
        ...
        try:
            ...
            self.logger.info(
                ...
                f"({filter_rate:.1f}%) para sección 'iberosfera'"
            )
    ...
    def _is_section_article(self, url: str) -> bool:
        ...
        target_section = "iberosfera"
        section_patterns = [
            rf"/{target_section}/",  # /iberosfera/
            rf"/{target_section}\.html",  # /iberosfera.html
            rf"/{target_section}-",  # /iberosfera-algo
            rf"/{target_section}_",  # /iberosfera_algo
            rf"-{target_section}-",  # algo-iberosfera-algo
            rf"_{target_section}_",  # algo_iberosfera_algo
        ]
    ...
    def extract_rss_data(self, entry) -> Dict[str, Any]:
        ...
        article_data = {
            ...
            "metadata": {
                ...
                "generation_date": "2025-07-01T19:04:30.123456",
                "frecuencia_minutos": 60,
            },
        }
