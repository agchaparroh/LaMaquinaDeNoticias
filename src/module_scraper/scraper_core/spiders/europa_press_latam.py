...
class EuropaPressLatamSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'CRAWL_ONCE_PATH': f'.scrapy/crawl_once/europa_press_latam',
    ...
    def _belongs_to_section(self, entry) -> bool:
        ...
        self.logger.debug(f"Artículo incluido por defecto (feed específico de Sudamérica)")
        return True
    ...
    def _is_section_article(self, url: str) -> bool:
        ...
        self.logger.debug(f"URL incluida por defecto (feed específico de Sudamérica): {url}")
        return True
