...
Fecha: 2025-07-01T03:32:43.773223
Estrategia: rss
...
class CubanetInternacionalSpider(scrapy.Spider):
    """
    Spider RSS para cubanet - internacional
    ...
    name = "cubanet_internacional"
    allowed_domains = ["cubanet.org"]
    ...
    custom_settings = {
        ...
        "CRAWL_ONCE_PATH": f".scrapy/crawl_once/cubanet_internacional",  # noqa: F541
        ...
        # Project: lamaquina
        # Spider: cubanet_internacional
        # Arguments: -a max_items=20
    }

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.rss_url = "https://www.cubanet.org/feed/"
        ...
        self.medio_info = {
            ...
            "area_geografica": "CUBA",
            "tipo_medio": "diario",
            "medio_url_principal": "https://www.cubanet.org/",
    ...
    def parse_rss(self, response):
        ...
        try:
            ...
            self.logger.info(
                ...
                f"({filter_rate:.1f}%) para sección 'internacional'"
            )
    ...
    def _is_section_article(self, url: str) -> bool:
        ...
        target_section = "internacional"
        section_patterns = [
            rf"/{target_section}/",  # /internacional/
            rf"/{target_section}\.html",  # /internacional.html
            rf"/{target_section}-",  # /internacional-algo
            rf"/{target_section}_",  # /internacional_algo
            rf"-{target_section}-",  # algo-internacional-algo
            rf"_{target_section}_",  # algo_internacional_algo
        ]
    ...
    def extract_rss_data(self, entry) -> Dict[str, Any]:
        ...
        article_data = {
            ...
            "metadata": {
                ...
                "generation_date": "2025-07-01T03:32:43.773223",
                "frecuencia_minutos": 60,
            },
        }
