...
class Centroamerica360RegionSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'CRAWL_ONCE_PATH': f'.scrapy/crawl_once/centroamerica360_region',
    ...
    def parse_rss(self, response):
        ...
        try:
            ...
            if test_feed.bozo and hasattr(test_feed, 'bozo_exception'):
                self.logger.warning(f"RSS mal formado detectado con Scrapy: {test_feed.bozo_exception}")
                ...
                if rss_content:
                    ...
                    self.logger.warning("⚠️ CloudScraper también falló, usando RSS de Scrapy")
        except Exception as e:
    ...
    def _belongs_to_section(self, entry) -> bool:
        ...
        self.logger.debug(f"Artículo incluido por defecto (feed específico de región)")
        return True
    ...
    def _is_section_article(self, url: str) -> bool:
        ...
        self.logger.debug(f"URL incluida por defecto (feed específico de región): {url}")
        return True
