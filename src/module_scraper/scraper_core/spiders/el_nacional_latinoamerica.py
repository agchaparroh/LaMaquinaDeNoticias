...
Fecha: 2025-07-01T19:25:00.123456
Estrategia: rss
...
class ElNacionalLatinoamericaSpider(scrapy.Spider):
    """
    Spider RSS para El Nacional - latinoamerica
    ...
    name = "el_nacional_latinoamerica"
    ...
    custom_settings = {
        ...
        "CRAWL_ONCE_PATH": f".scrapy/crawl_once/el_nacional_latinoamerica",  # noqa: F541
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.medio_info = {
            ...
            "tipo_medio": "diario",
            "medio_url_principal": "https://www.elnacional.com/mundo/latinoamerica/",
    ...
    def _is_section_article(self, url: str) -> bool:
        ...
        target_section = "latinoamerica"
        section_patterns = [
            rf"/{target_section}/",  # /latinoamerica/
            rf"/{target_section}\.html",  # /latinoamerica.html
            rf"/{target_section}-",  # /latinoamerica-algo
            rf"/{target_section}_",  # /latinoamerica_algo
            rf"-{target_section}-",  # algo-latinoamerica-algo
            rf"_{target_section}_",  # algo_latinoamerica_algo
        ]
    ...
    def extract_rss_data(self, entry) -> Dict[str, Any]:
        ...
        article_data = {
            ...
            "metadata": {
                ...
                "generation_date": "2025-07-01T19:25:00.123456",
                "frecuencia_minutos": 60,
            },
        }
