...
Sección: politica
Fecha: 2025-07-01T06:21:22.897306
Estrategia: rss
...
class Centroamérica360PoliticaSpider(scrapy.Spider):
    """
    Spider RSS para Centroamérica360 - politica
    ...
    name = "centroamérica360_politica"
    allowed_domains = ["centroamerica360.com"]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.medio_info = {
            "medio": "Centroamérica360",
            "seccion": "politica",
            "area_geografica": "CENTROAMÉRICA",
            "tipo_medio": "diario",
            "medio_url_principal": "https://www.centroamerica360.com/",
    ...
    def parse_rss(self, response):
        ...
        try:
            ...
            filter_rate = (
                (articles_accepted / articles_processed * 1)
    ...
    def extract_rss_data(self, entry) -> Dict[str, Any]:
        ...
        article_data = {
            ...
            "metadata": {
                ...
                "generation_date": "2025-07-01T06:21:22.897306",
                "frecuencia_minutos": 30,
            },
        }
