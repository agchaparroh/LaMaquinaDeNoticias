...
def main():
    ...
    config_file = os.environ.get(
        "SCRAPYDWEB_SETTINGS_PY", "/app/config/scrapydweb_settings_v11.py"
    )
    ...
    try:
        ...
        sys.argv = [
            "scrapydweb",
            "--bind",
            os.environ.get("SCRAPYDWEB_BIND", "0.0.0.0"),
            "--port",
            os.environ.get("SCRAPYDWEB_PORT", "5000"),
            "-ss",
            "scrapyd:6800",  # Usar -ss en lugar de --scrapyd_server
        ]
