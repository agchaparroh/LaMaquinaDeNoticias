...
class TestNginxSecurity:
    ...
    def test_api_rate_limiting(
        self, nginx_container_running, nginx_base_url, http_session
    ):
    ...
    def test_general_rate_limiting(self, nginx_container_running, nginx_base_url):
        ...
        assert len(rejected) > 0, (
            "Rate limiting no está funcionando para rutas generales"
        )
    ...
    def test_error_page_no_info_disclosure(
    ...
    def test_concurrent_connections_limit(
        self, nginx_container_running, nginx_base_url
    ):
    ...
    def test_headers_not_exposing_backend_info(
        self, nginx_container_running, nginx_base_url
    ):
