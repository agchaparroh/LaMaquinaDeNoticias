...
class DashboardUser(HttpUser):
    ...
    def api_get_news(self):
        ...
        with self.client.get(
            "/api/v1/news", params=params, catch_response=True, name="api_news"
        ) as response:
    ...
    def api_search(self):
        ...
        params = {"q": random.choice(search_terms), "type": "news", "limit": 20}
    ...
    def api_post_action(self):
        ...
        self.client.post("/api/v1/actions", json=data, name="api_post_action")
...
class APIUser(HttpUser):
    ...
    def api_batch_request(self):
        ...
        endpoints = ["/api/v1/news", "/api/v1/analytics", "/api/v1/status"]
    ...
    def api_heavy_query(self):
        ...
        with self.client.get(
            ...
            if response.elapsed.total_seconds() > 5:
                response.failure(
                    f"Query muy lenta: {response.elapsed.total_seconds()}s"
                )
    ...
    def api_concurrent_posts(self):
        ...
        for i in range(3):
            ...
            self.client.post("/api/v1/batch", json=data, name="api_batch_post")
