...
def test_pipeline_coordinator_mapping():
    ...
    cita_data_correcto = {
        ...
        "id_temporal_hecho_contexto": str(metadata_dict.get('hecho_relacionado_id', '')),
    ...
    cita_data_incorrecto = {
        ...
        "hecho_principal_relacionado_id_temporal": str(cita.metadata_cita.hecho_relacionado_id),  # INCORRECTO
...
def test_escala_relevancia():
    ...
    # Test valor válido
    try:
        cita_valida = CitaTextualExtraidaItem(
            id_temporal_cita="CITA-001",
    ...
    try:
        cita_invalida = CitaTextualExtraidaItem(
