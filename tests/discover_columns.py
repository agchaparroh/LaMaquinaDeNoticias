...
test_inserts = {
    "entidades": {"nombre": "Test", "tipo": "PERSONA"},
    "hechos": {
        "contenido": "Test",
        "fecha_ocurrencia": "[2024-01-01,2024-01-02)",
        "tipo_hecho": "SUCESO",
    },
    "citas_textuales": {"cita": "Test quote", "articulo_id": 1},
    "datos_cuantitativos": {"hecho_id": 1, "articulo_id": 1, "indicador": "Test"},
}
...
for table in relation_tables:
    ...
    try:
        ...
        print(f"✅ Insert exitoso (inesperado)")  # noqa: F541
    except Exception as e:
