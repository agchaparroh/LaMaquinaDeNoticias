...
def create_entity_data():
    ...
    class MockEntity:
        def __init__(self):
            ...
            self.metadata_entidad = type(
                "obj", (object,), {"model_dump": lambda self: {"source": "test"}}
            )()
...
def test_id_temporal():
    ...
    assert entity_data["id_temporal"] == entity_data["id"], (
        "ERROR: id_temporal doesn't match id!"
    )
