        ...
        try:
            ...
            for table in known_tables:
                try:
                    ...
                    test_response = supabase.table(table).select("*").limit(1).execute()  # noqa: F841
            ...
            try:
                ...
                try:
                    response = supabase.rpc(
                        "execute_sql", {"query": columns_query}
                    ).execute()
                    ...
                    if response.data:
                        ...
                        for col in response.data:
                            ...
                            print(
                                f"  - {col['column_name']:<30} {col['data_type']:<15} {nullable}{default}"
                            )
                    else:
                    ...
                    if sample_response.data and len(sample_response.data) > 0:
                        ...
                        for field, value in sample_record.items():
                            ...
                            print(
                                f"  - {field:<30} {value_type:<15} = {str(value)[:30]}"
                            )
                    else:
