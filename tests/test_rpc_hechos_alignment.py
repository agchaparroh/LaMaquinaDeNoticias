    ...
    return [
        {
            ...
            "detalle_complejo_hecho": {"duracion_minutos": 60, "numero_asistentes": 50},
            "entidades_del_hecho": [],
        },
        {
            # Campos principales alineados con RPC actualizado
        ...
        },
        {
            ...
            "detalle_complejo_hecho": {"numero_paises": 50, "duracion_dias": 3},
            "entidades_del_hecho": [],
        },
    ]
...
def verificar_campos_hecho(hecho_dict):
    ...
    if errores_encontrados:
        print(f"\n   ⚠️  ERRORES: Campos con nombres antiguos encontrados:")  # noqa: F541
    ...
    try:
        ...
        if "hechos_extraidos" in payload_dict:
            ...
            if payload_dict["hechos_extraidos"]:
                ...
                print(
                    f"   - precision_temporal: {primer_hecho.get('precision_temporal')}"
                )
        ...
        if payload_dict["hechos_extraidos"]:
            primer_hecho_json = json.dumps(
                payload_dict["hechos_extraidos"][0], indent=2, ensure_ascii=False
            )
        ...
        if resultado["success"]:
            ...
            print(
                f"   Detalles: {resultado.get('details', 'Sin detalles adicionales')}"
            )
