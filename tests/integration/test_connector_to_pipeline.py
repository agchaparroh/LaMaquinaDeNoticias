...
class MockArticle:
    ...
    def __init__(self, **kwargs):
        ...
        self.contenido_texto = kwargs.get(
            "contenido_texto", "Contenido de prueba con más de 50 caracteres necesarios"
        )
    ...
    def model_dump(self):
        ...
        return {
            ...
            if hasattr(self.fecha_publicacion, "isoformat")
            else str(self.fecha_publicacion),
            "contenido_texto": self.contenido_texto,
            "url": self.url,
            "idioma": self.idioma,
            "fecha_recopilacion": self.fecha_recopilacion.isoformat()
            if hasattr(self.fecha_recopilacion, "isoformat")
            else str(self.fecha_recopilacion),
        }
    ...
    async def simulate_validation_error():
        ...
        if len(article_dict["contenido_texto"]) < 50:
            return 400, {
                ...
                "detalles": [
                    "Campo 'contenido_texto' debe tener al menos 50 caracteres"
                ],
            }
