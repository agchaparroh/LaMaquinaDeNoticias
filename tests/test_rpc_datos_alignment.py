...
def main():
    ...
    try:
        ...
        if "datos_cuantitativos_extraidos" in payload_dict:
            print(
                f"   - Datos en payload: {len(payload_dict['datos_cuantitativos_extraidos'])}"
            )
            ...
            if payload_dict["datos_cuantitativos_extraidos"]:
                ...
                if "hecho_principal_relacionado_id_temporal" in primer_dato:
                    campos_incorrectos.append(
                        "hecho_principal_relacionado_id_temporal (debe ser id_temporal_hecho)"
                    )
                ...
                if not primer_dato.get("ambito_geografico"):
                    print(
                        "   ⚠️  ADVERTENCIA: Campo 'ambito_geografico' está vacío (requerido por RPC)"
                    )
        ...
        if resultado["success"]:
            ...
            if "data_count" in resultado:
                print(
                    f"   - Datos cuantitativos persistidos: {resultado['data_count']}"
                )
