...
class DevelopmentStorageService:
    ...
    def insertar_fragmento_completo(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            resultado_file = self._save_resultado_final(
                payload, fragmento_id, timestamp
            )
    ...
    def _save_resultado_final(
        self, payload: Dict, fragmento_id: str, timestamp: str
    ) -> str:
        fecha = datetime.now().strftime("%Y-%m-%d")  # noqa: F841
