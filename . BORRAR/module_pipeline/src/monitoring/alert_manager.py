...
class AlertManager:
    ...
    def _check_pipeline_specific_errors(self, record: Dict[str, Any], level: str, message: str, extra: Dict[str, Any]):
        ...
        if any(term in message.lower() for term in ["consolidation", "consolidar", "duplicat"]):
            self._trigger_alert(
                ...
                annotations={
                    "message": message[:500],
                    "similarity_threshold": str(extra.get("similarity_threshold", "unknown"))
                }
            )
    ...
    def _check_pipeline_health(self, record: Dict[str, Any], extra: Dict[str, Any]):
        ...
        pipeline_duration = extra.get("pipeline_duration_seconds") or extra.get("duration_seconds")
