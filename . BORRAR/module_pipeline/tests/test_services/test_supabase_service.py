...
class TestSupabaseService:
    ...
    def test_singleton_global_function(self):
        ...
        assert service1 is service2, (
            "get_supabase_service debe retornar el mismo objeto"
        )
    ...
    def test_get_client(self, mock_create_client):
        ...
        with patch(
            "src.services.supabase_service.SUPABASE_URL", "https://test.supabase.co"
        ), patch("src.services.supabase_service.SUPABASE_KEY", "test-key"):
            service = SupabaseService()
    ...
    def test_buscar_entidad_similar_success(self, mock_create_client):
        ...
        with patch(
            ...
            results = service.buscar_entidad_similar(
                "Pedro Sanchez", tipo_entidad="PERSONA", umbral_similitud=0.8
            )
            ...
            mock_client.rpc.assert_called_once_with(
                "buscar_entidad_similar", expected_params
            )
    ...
    def test_retry_on_failure(self, mock_create_client):
        ...
        with patch(
            "src.services.supabase_service.SUPABASE_URL", "https://test.supabase.co"
        ), patch("src.services.supabase_service.SUPABASE_KEY", "test-key"), patch(
            "src.services.supabase_service.MAX_RETRIES", 2
        ):
            service = SupabaseService()
