    ...
    def get_aggregated_metrics(self) -> Dict[str, Any]:
        ...
        with self._operation_lock:
            ...
            phase_stats = defaultdict(lambda: {
                "success": 0, "total": 0, "total_time": 0.0,
                "chunks_total": 0, "parallel_count": 0, "chunking_count": 0
            })
            ...
            for phase, stats in phase_stats.items():
                ...
                phase_chunking_stats[phase] = {
                    "chunking_usage_percent": (stats["chunking_count"] / max(stats["total"], 1)) * 100,
                    "parallel_processing_percent": (stats["parallel_count"] / max(stats["total"], 1)) * 100,
                    "average_chunks_per_execution": stats["chunks_total"] / max(stats["chunking_count"], 1)
                }
...
if __name__ == '__main__':
    ...
    phases = [
        "Fase1_Triaje", "Fase2_Simplificacion", "Fase3_Entidades", 
        "Fase4_Hechos", "Fase5_Datos", "Fase6_Citas", "Fase7_Normalizacion"
    ]
    for phase in phases:
        for i in range(3):
