...
class PipelineCoordinator:
    ...
    def ejecutar_pipeline_completo(
        ...
        try:
            # === FASE 1: TRIAJE ===
            with log_phase(
                "Fase1_Triaje", request_id, fragment_id=str(fragmento_uuid)
            ) as phase_logger:
            ...
            if flujo_config["chunking_aplicado"]:
                with log_phase(
                    "Chunking", request_id, fragment_id=str(fragmento_uuid)
                ) as phase_logger:
            ...
            if flujo_config["simplificacion_aplicada"]:
                with log_phase(
                    "Fase2_Simplificacion", request_id, fragment_id=str(fragmento_uuid)
                ) as phase_logger:
            ...
            entidades_data.append(
                {
                    ...
                    "nombre_entidad": entidad.nombre_entidad_normalizada
