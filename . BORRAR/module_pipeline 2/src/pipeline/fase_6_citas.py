...
# Importar modelos
from ..models.procesamiento import CitaTextual, EntidadProcesada, HechoProcesado
...
async def extraer_citas_con_chunking_paralelo(
    ...
    resultado = {
        ...
        "tipos_citas": _contar_tipos_citas(todas_las_citas) if todas_las_citas else {},  # noqa: F821
