...
class TestPipelineLogger:
    ...
    def test_logger_initialization(self, temp_log_dir):
        ...
        with patch.object(
            LoggingConfig, "get_log_dir", return_value=Path(temp_log_dir)
        ):
...
class TestLogContext:
    ...
    def test_get_logger_from_context(self):
        ...
        context = LogContext(request_id="REQ-002", component="TestComponent")
...
class TestFastAPIIntegration:
    ...
    def test_setup_fastapi_logging(self):
        ...
        with patch("src.utils.logging_config.logger") as mock_logger:  # noqa: F841
