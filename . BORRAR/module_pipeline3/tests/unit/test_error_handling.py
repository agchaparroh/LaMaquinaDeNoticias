...
from src.utils.error_handling import (
    ...
    extract_validation_errors,  # noqa: F401
    ...
    handle_groq_translation_fallback_fase1,  # noqa: F401
...
class TestCustomExceptions:
    ...
    def test_service_unavailable_error(self):
        ...
        exc = ServiceUnavailableError(retry_after=300, queue_size=150, workers_active=3)
...
class TestErrorResponses:
    ...
    def test_create_validation_error_response_direct(self):
        ...
        errors = ["El título es demasiado largo", "La fecha no tiene formato válido"]
    ...
    async def test_async_create_error_response(self):
        ...
        exc = GroqAPIError(message="API timeout", phase=ErrorPhase.FASE_3_CITAS_DATOS)
...
class TestFallbackHandlers:
    ...
    def test_handle_groq_extraction_error_fase2(self):
        ...
        assert (
            result["hechos_extraidos"][0]["texto_original_del_hecho"]
            == "Noticia importante sobre economía"
        )
    ...
    def test_handle_groq_citas_error_fase3(self):
        ...
        result = handle_groq_citas_error_fase3(
            article_id="art_citas_test", exception=RuntimeError("Model overloaded")
        )
    ...
    def test_handle_groq_relations_error_fase4(self):
        ...
        result = handle_groq_relations_error_fase4(
            article_id="art_rel_test", exception=TimeoutError("Timeout")
        )
    ...
    def test_handle_importance_ml_error(self):
        ...
        result = handle_importance_ml_error(
            article_id="art_ml_test", exception=FileNotFoundError("Model not found")
        )
...
class TestIntegration:
    ...
    def test_retry_decorator_with_custom_exception(self):
        ...
        @retry_with_backoff(max_attempts=2, wait_min=0.1, exceptions=(GroqAPIError,))
        def api_call():
            nonlocal attempt_count
            attempt_count += 1
            if attempt_count < 2:
                raise GroqAPIError("API failed", phase=ErrorPhase.FASE_1_TRIAJE)
            return "Success"
    ...
    def test_fallback_chain_fase2(self):
        ...
        result1 = handle_groq_extraction_error_fase2(
            article_id="art_chain", titulo="Título de prueba", exception=TimeoutError()
        )
