...
# Importar modelos
from ..models.procesamiento import DatosCuantitativos, EntidadProcesada, HechoProcesado
...
from ..utils.validation import escape_html  # noqa: F401
    ...
    for dato in datos_raw:
        try:
            ...
            dato_procesado = DatosCuantitativos(
                ...
                fecha_dato=f"{fecha_inicio} - {fecha_fin}"
