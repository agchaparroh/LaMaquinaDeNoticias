...
class PipelineCoordinator:
        ...
        if fragmento.id_fragmento.startswith("ART-"):
            ...
            try:
                ...
                self.base_logger.error(
                    f"ID de fragmento inválido: {fragmento.id_fragmento}"
                )
                raise ValueError(
                    f"El ID del fragmento no es válido: {fragmento.id_fragmento}"
                )
    ...
    def _crear_payload_no_relevante(
        self, fragmento: FragmentoProcesableItem, resultado_fase1: ResultadoFase1Triaje
            ...
            hechos_data.append(
                {
                    ...
                    "relevancia_hecho": int(
                        hecho.confianza_extraccion * 10
                    ),  # 0.0-1.0 → 1-10
