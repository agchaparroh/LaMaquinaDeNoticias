    ...
    def get_embedding_stats(self) -> Dict[str, Any]:
        ...
        for table in tables_with_embeddings:
            try:
                ...
                with_embeddings = self.get_table_record_count(
                ...
                stats[table] = {
                    ...
                    "completion_percentage": (with_embeddings / total * 100)
                    if total > 0
                    else 0,
                }
    ...
    if db.connect():
        ...
        for table, table_stats in stats.items():
            if "error" in table_stats:
                ...
                logger.info(
                    f"  {table}: {table_stats['with_embeddings']}/{table_stats['total_records']} "
