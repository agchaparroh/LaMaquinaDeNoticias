...
CREATE TABLE articulos (
    ...
    error_detalle TEXT,
    contenido_texto TEXT, -- [AÑADIDO 28/05/2025] Contenido completo del artículo procesado desde Storage
...
CREATE INDEX idx_dimension_tiempo_periodo_gin ON dimension_tiempo USING gin(periodo_historico);)
    -- Nota: contenido_texto almacena el contenido procesado para consultas rápidas
);
